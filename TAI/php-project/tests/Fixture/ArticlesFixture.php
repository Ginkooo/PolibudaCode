...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'fixed' => null, 'collate' => null],
        ...
        '_constraints' => [
            ...
            'sqlite_autoindex_articles_1' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public $records = [
        [
            ...
            'created' => '2017-12-19 16:56:33',
            'modified' => '2017-12-19 16:56:33'
        ],
    ];
}
