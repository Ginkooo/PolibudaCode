...
int get_key_code() {
	...
	switch(x) {
		case 0b11111110: { turn_off_diode(); fnum = 0; return 1; }; //kolumna 1 klawisz 1
	...
	switch(x) {
		case 0b11111110: {if(fnum==0) {force_diode_off = 0; fnum = 1; show_blink_menu();} return 2;} //kolumna 2 klawisz 1
	...
	switch(x) {
		case 0b11111110: {if(fnum==0) fnum = 2; turn_off_diode(); return 3;} //kolumna 3 klawisz 1
